package Purpleye.FIDGETControlls;
...
Terminal
	...
	public static List<String> loadAllAvailableFonts(){
		return List.of(STANDARD_FLF,BANNER_FLF,BIG_FLF,BLOCK_FLF,BUBBLE_FLF,DIGITAL_FLF,IVRIT_FLF,LEAN_FLF,MINI_FLF,
				MNEMONIC_FLF,SCRIPT_FLF,SHADOW_FLF,SLANT_FLF,SMALL_FLF,SMSCRIPT_FLF,SMSHADOW_FLF,SMSLANT_FLF,
				TERM_FLF);
	}
}
